...
התוכנית העסקית: מכירת אינפורמציה על המשתמשים. 
הסבר:
האפליקציה מאפשרת לגולש למסור מוצרי מזון סגורים שהוא עומד לזרוק לאנשים שעדיין יכולים למצוא בהם שימוש, 
המוסרים יכולים להיות אנשים פרטיים, מסעדות שבסוף יום רוצים לזרוק הכול, או סופרים שזורקים אוכל טרי שלא נמכר.  
...
יהיו שתי מצבי תצוגה, אחד שמראה  רק פוסט אחד בכל פעם, ואחד שמראה שלושה פוסטים במקביל. (זה כשהגולש ממחשב, ולא ממובייל)
